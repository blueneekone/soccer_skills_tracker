...
Objective
Overhaul the public marketing landing page (src/routes/(marketing)/+page.svelte) to enforce the "Nuclear Americana Tech Noir" design system and the "Training Triangle" narrative.
CRITICAL GUARDRAIL: This is a public, prerender = true static route
. The agent is STRICTLY FORBIDDEN from invoking Firebase auth, minting JWT tokens, or attempting to log in during this workflow. Do not test authentication.
