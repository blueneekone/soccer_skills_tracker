...
#### Steps
1. **Persona Execution Loop:** The main orchestrator agent MUST execute Steps 2-5 sequentially for the following personas: Admin, Director, Coach, Player, and Parent. Do not proceed to the next persona in the loop until the current one has zero failing tests and zero UI/UX bugs.
