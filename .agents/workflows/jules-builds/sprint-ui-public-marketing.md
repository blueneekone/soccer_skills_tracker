# JULES PIPELINE: PUBLIC MARKETING UI/UX POLISHING SPRINT
## Role: Lead UI/UX Architect
## Mission: Polish the Public Marketing landing pages, enforcing Bento Grid layouts and Nuclear Yellow/Data Cyan aesthetics.

### Context & Rules:
1. The Public Marketing pages must strictly adhere to the Enterprise Design System.
...
### Task:
Navigate to the Public Marketing routes (e.g. `src/routes/(marketing)/`) and conduct a deep visual audit.
