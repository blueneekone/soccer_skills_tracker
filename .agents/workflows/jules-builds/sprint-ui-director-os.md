# JULES PIPELINE: DIRECTOR OS UI/UX POLISHING SPRINT
## Role: Lead UI/UX Architect
## Mission: Polish the Director OS dashboard, enforcing Bento Grid layouts and Nuclear Yellow/Data Cyan aesthetics.

### Context & Rules:
1. The Director OS must strictly adhere to the Enterprise Design System.
...
### Task:
Navigate to the Director components (e.g. `src/routes/(app)/director/`, `src/lib/components/director/`) and conduct a deep visual audit.
