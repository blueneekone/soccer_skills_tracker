...
FILE_MAPPINGS = {
    "firebase-v2.json": "firebase.json",
    "firestore.rules": "firestore.rules",
    "AGENTS.md": "AGENTS.md",
    "jules_remediation_runner-v2.py": "jules_remediation_runner.py",
...
def trigger_jules_workflow(api_key, repo_id, workflow_name, workflow_file, branch="main"):
...
def main():
    ...
    if choice_jules == 'y':
        ...
        branch = input(f"{Colors.BOLD}Enter your target GitHub Branch (default is 'main'): {Colors.ENDC}").strip()
        if not branch:
            branch = "main"
