...
/**
 * integrations.js — External Media Proxy Functions
 * ──────────────────────────────────────────────────
 ...
 *
 * Exports:
 *   getSoccerNews    — onCall: fetch + parse RSS feeds, return normalised articles
 *   searchPodcasts   — onCall: search iTunes for soccer/coaching podcasts
 */
 ...
 * Server-side sanitisation — eliminates XSS risk before sending to client.
 * @param {string} raw
 * @return {string}
 */
