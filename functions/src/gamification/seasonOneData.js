...
const SEASON_STICKER_VARIANTS = /** @type {const} */ ([
	'base',
	'holo',
	'radiant',
	'alt-art',
 ...
 */
function normalizeStickerVariant(v) {
 ...
 */
const seasonOneCards = /** @type {SeasonOneCard[]} */ ([
	/* ─── The Street Kings ─── */
	{
		id: 'card_001_base',
 ...
 */
function getSeasonOneCardsForSet(setId) {
 ...
 * @returns {SeasonOneCard[]}
 */
function getSeasonOneCardsByConcept(conceptId) {
 ...
 */
function getSeasonOneSetById(id) {
 ...
 */
function getSeasonOneCardById(cardId) {
