...
- Name: tests\visual-regression-v5.spec.ts >> EPIC COMPREHENSIVE TRAVERSAL: PARENT OS >> Navigate & Audit: TRUST-CENTER
...
Call log:
  - waiting for locator('.pd-page-root, .compliance-vault') to be visible
  ...
  - generic [ref=e9]:
    ...
    - generic [ref=e47]:
      ...
      - main [ref=e82]:
        - generic [ref=e83]:
          - generic [ref=e84]:
            - heading "Co-op Trust Center" [level=1] [ref=e85]
            - paragraph [ref=e86]: Legal Compliance, Financial Escrow, and Communication Audits
          - generic [ref=e87]:
            - heading "Verifiable Parental Consent (VPC)" [level=2] [ref=e88]
            - paragraph [ref=e89]: COPPA 2.0 and SafeSport mandates require hardware biometric attestation to approve minor participation.
            - button "Attest via TouchID / FaceID" [ref=e90]
          - generic [ref=e91]:
            - generic [ref=e92]:
              - heading "Communication Audit Log" [level=2] [ref=e93]
              - paragraph [ref=e94]: All 1:1 adult-to-minor messaging is prohibited. This log displays all messages routed to your minor.
              - paragraph [ref=e96]: No communications logged.
            - generic [ref=e97]:
              - heading "Bounty Escrow Terminal" [level=2] [ref=e98]
              - paragraph [ref=e99]: Fund real-world rewards (Tremendous Gift Cards) that automatically release upon Computer Vision (CV) verified workout completions.
              - generic [ref=e100]:
                - generic [ref=e101]: $
                - spinbutton "Enter amount" [ref=e102]: "0"
              - button "Lock Funds in Escrow" [ref=e103]
          - generic [ref=e104]:
            - heading "Post-Match Protocol" [level=2] [ref=e105]
            - paragraph [ref=e106]: Raw metrics are suppressed for 15 minutes post-match to protect beginner self-worth.
            - generic [ref=e107]:
              - paragraph [ref=e108]: Empathetic Conversation Anchor
              - paragraph [ref=e109]: "\"I loved watching you play today.\""
  - complementary [ref=e110]
  - complementary [ref=e111]:
    - generic [ref=e112]:
      - heading [level=2] [ref=e117]: Alerts
      - button [ref=e118] [cursor=pointer]
    - generic [ref=e121]:
      - paragraph [ref=e123]: No alerts right now.
      - paragraph [ref=e124]: We'll notify you when something needs your attention.
```
