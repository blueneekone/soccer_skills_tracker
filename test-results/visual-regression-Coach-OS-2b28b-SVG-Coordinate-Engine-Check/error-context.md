...
- Name: visual-regression.spec.ts >> Coach OS Tactical SIEM Audit >> The Tron War Room SVG Coordinate Engine Check
- Location: visual-regression.spec.ts:240:5
...
Call log:
  - navigating to "/coach/war-room", waiting until "load"
