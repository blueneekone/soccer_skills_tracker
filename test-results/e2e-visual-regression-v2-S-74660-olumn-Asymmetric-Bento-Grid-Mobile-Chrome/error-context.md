...
Call log:
  ...
  - waiting for locator('h1')
    14 × locator resolved to <h1 class="tw-text-4xl md:tw-text-5xl tw-font-bold tw-text-[#f8fafc] tw-tracking-tight tw-leading-[1.05] tw-max-w-4xl s--zsgoZJfXwoG">Focus on development, not just management.</h1>
