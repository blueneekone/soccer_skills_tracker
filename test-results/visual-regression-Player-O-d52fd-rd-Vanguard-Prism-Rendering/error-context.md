...
- Name: visual-regression.spec.ts >> Player OS Gamified HUD Audit >> Widescreen TCG Player Card & Vanguard Prism Rendering
- Location: visual-regression.spec.ts:273:5
...
Call log:
  - navigating to "/player/dashboard", waiting until "load"
