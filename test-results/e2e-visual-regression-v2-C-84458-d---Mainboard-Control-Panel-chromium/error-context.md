...
- Name: e2e\visual-regression-v2.spec.ts >> Coach OS - Multi-Page Tactical Audits >> Coach Dashboard - Mainboard Control Panel
...
- main:
  ...
  - text: Test Player
  - alert:
    - text: CLEARANCE NOT STARTED
    - heading "ACCESS RESTRICTED" [level=1]
    - text: "UID: —… CLUB: — STATUS: BGC PENDING"
    - link "[ CONTACT COMPLIANCE OFFICER ]":
