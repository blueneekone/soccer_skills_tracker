...
- Name: e2e\visual-regression-v5.spec.ts >> EPIC COMPREHENSIVE TRAVERSAL: PLAYER OS >> Navigate & Audit: DASHBOARD
...
Call log:
  - waiting for locator('.player-dossier-root, .st-bento') to be visible
...
- main [ref=e4]:
  ...
  - generic [ref=e9]:
    ...
    - generic [ref=e35]:
      ...
      - alert [ref=e68]:
        - paragraph [ref=e70]: Unable to load this operative profile. Try refreshing the page.
  - complementary [ref=e71]
  - complementary [ref=e72]:
    - generic [ref=e73]:
      - heading [level=2] [ref=e78]: Alerts
      - button [ref=e79] [cursor=pointer]
    - generic [ref=e82]:
      - paragraph [ref=e84]: No alerts right now.
      - paragraph [ref=e85]: We'll notify you when something needs your attention.
```
