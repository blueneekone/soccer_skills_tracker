...
- Name: visual-regression-v2.spec.ts >> Coach OS - Multi-Page Tactical Audits >> Coach Daily Intel - Telemetry Sync & Intel Feeds
...
- generic [ref=e2]:
  - main [ref=e4]:
    - status "Redirecting" [ref=e5]
  - generic [ref=e7]: Daily Intel · Coach OS
```
