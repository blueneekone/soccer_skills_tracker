...
- main [ref=e4]:
  ...
  - generic [ref=e9]:
    ...
    - generic [ref=e47]:
      ...
      - generic [ref=e82]:
        - generic [ref=e84]:
          - paragraph [ref=e85]: Parent OS · TIER-0 ACCESS
          - heading "Household Clearance Center" [level=1] [ref=e86]
          - paragraph [ref=e87]: Classified provisioning. Minors do not self-register. Digital signatures and dispatch codes are the only valid ingress paths.
        - generic [ref=e88]:
          - region [ref=e90]:
            - generic [ref=e91]:
              - generic [ref=e92]: COPPA & LIABILITY
              - heading "Minor accounts locked" [level=2] [ref=e93]
            - paragraph [ref=e94]: Until you execute the digital signature below, child operative accounts in this household remain inert (no self-initiation). By signing, you assert parental authority to provision credentials per club policy and federal child-privacy law.
            - generic [ref=e95]:
              - generic [ref=e96]: Clearance file
              - generic [ref=e97]: PENDING SIGNATURE
            - paragraph [ref=e98]: Household / club line
            - generic [ref=e99]: "HH: — (created on sign) · Club: aggiesfc"
            - button "Sign waiver & authorize" [ref=e100] [cursor=pointer]
          - generic [ref=e101]:
            - region [ref=e102]:
              - generic [ref=e103]:
                - text: Operative generation
                - heading "Credential dispatch" [level=2] [ref=e104]
              - paragraph [ref=e105]: Register the minor’s legal display name and a unique Operative Callsign (username for sign-in). A proxy account is created automatically. The engine issues a one-time DISPATCH code for Operative login.
              - generic [ref=e106]:
                - generic [ref=e107]:
                  - generic [ref=e108]: Operative name
                  - textbox "Operative name" [ref=e109]:
                    - /placeholder: Full name (minor)
                - generic [ref=e110]:
                  - generic [ref=e111]: Operative Callsign (required)
                  - textbox "Operative Callsign (required)" [ref=e112]:
                    - /placeholder: e.g. Red-Fox, striker99
                - generic [ref=e113]:
                  - generic [ref=e114]:
                    - generic [ref=e115]: Dispatch Code (optional)
                    - button "[ ? ]" [ref=e117]
                  - textbox "Dispatch Code (optional)" [ref=e118]:
                    - /placeholder: e.g. AB-1K2M
                  - paragraph [ref=e119]: Optional team dispatch code from your coach (e.g. AB-1K2M). Links your operative to the roster when you provision credentials.
              - button "Generate operative credentials" [disabled] [ref=e121] [cursor=pointer]
            - region [ref=e122]:
              - generic [ref=e123]:
                - text: Club transfer
                - heading "Vanguard transfer protocol" [level=2] [ref=e124]
              - paragraph [ref=e125]: Initiate a player transfer to another club. You will receive a token to share with the destination registrar; confirm with their auth code when prompted.
              - generic [ref=e126]:
                - generic [ref=e127]:
                  - generic [ref=e133]:
                    - generic [ref=e134]: VANGUARD TRANSFER PROTOCOL
                    - generic [ref=e135]: PARENT AUTHORIZATION TERMINAL
                  - generic [ref=e136]: RESTRICTED
                - generic [ref=e138]:
                  - generic [ref=e139]:
                    - generic [ref=e140]: "1"
                  ...
                  - generic [ref=e145]:
                    ...
                    - text: DATA PORTED
                - generic [ref=e148]:
                  - generic [ref=e149]: "⚠ ZERO-TRUST PROTOCOL: Transfers are irreversible without re-initiation. Only the COPPA-verified parent account may authorize movement of player data."
                  - generic [ref=e150]:
                    - text: PLAYER EMAIL
                    - textbox "player@club.com" [ref=e151]
                  - button "[ INITIATE TRANSFER PROTOCOL ]" [ref=e152]
                - generic [ref=e153]: COPPA-VERIFIED · HMAC-SHA256 · 48H TOKEN TTL VANGUARD NEXUS v4
  - complementary [ref=e154]
  - complementary [ref=e155]:
    - generic [ref=e156]:
      - heading [level=2] [ref=e161]: Alerts
      - button [ref=e162] [cursor=pointer]
    - generic [ref=e165]:
      - paragraph [ref=e167]: No alerts right now.
      - paragraph [ref=e168]: We'll notify you when something needs your attention.
```
