...
|----|-------|-------|--------|---------|----------|------|
| PS-A01 | `/login` | Sign in | | | | |
| PS-A02 | `/home` | Workspace router | | | | |
| PS-A03 | `/setup` | Account setup | | | | |
| PS-A04 | `/vpc-pending` | VPC gate | | | | |
| PS-A05 | `/compliance` | Coach clearance | | | | |
| PS-A06 | `/privacy` | Privacy policy | | | | |
| PS-P01 | `/parent/household` | Household | | | | |
| PS-P02 | `/parent/vpc` | Consent (VPC) | | | | |
| PS-P03 | `/parent/dashboard` | Co-op Command | | | | |
| PS-C01 | `/coach` | Daily Intel | | | | |
| PS-C02 | `/coach/forge` | The Forge | | | | |
| PS-PL01 | `/player/dashboard` | HQ | | | | |
| PS-PL02 | `/player/workout` | Train | | | | |
| PS-PL03 | `/stats` | Stats | | | | |
| PS-X01 | `/messages` | Messages | | | | |
