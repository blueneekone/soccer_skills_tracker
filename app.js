...
import { initCoachDropdown, loadCoachDashboard, currentCoachTeamId, initStrategyBoard, loadCoachScheduleAndHW } from "./modules/coach.js?v=4.0.2";
...
import { loadStatsDashboard } from "./modules/stats.js?v=4.0.4"; // Only importing what the router needs!
