...
const safeBind = (id, event, func) => {
    ...
    if(el) {
        // Prevent double-binding if we re-run init
...
const initApp = () => {
    console.log("App v31 Loaded (Full Feature Set)");
    ...
    safeBind("exportXlsxBtn", "click", exportSessionData); // This was missing before!
