...
const LEGACY_SPORT_CONFIGS = Object.freeze({
  soccer: {
    ...
    attributes: [
      ...
      { id: 'dribbling', name: 'Dribbling',             shortLabel: 'DRI', hexColor: '#00f0ff', playerStatKey: 'dribbling' },
  ...
  basketball: {
    ...
    attributes: [
      ...
      { id: 'defense',    name: 'Defense',         shortLabel: 'DEF', hexColor: '#00f0ff', playerStatKey: 'defense'    },
  ...
  baseball: {
    ...
    attributes: [
      ...
      { id: 'fielding', name: 'Fielding',      shortLabel: 'FLD', hexColor: '#00f0ff', playerStatKey: 'fielding' },
  ...
  football: {
    ...
    attributes: [
      ...
      { id: 'agility',   name: 'Agility',   shortLabel: 'AGI', hexColor: '#00f0ff', playerStatKey: 'agility'  },
  ...
  volleyball: {
    ...
    attributes: [
      ...
      { id: 'setting',  name: 'Setting',  shortLabel: 'SET', hexColor: '#00f0ff', playerStatKey: 'setting'  },
  ...
  hockey: {
    ...
    attributes: [
      ...
      { id: 'shooting',       name: 'Shooting',        shortLabel: 'SHO', hexColor: '#ff0055', playerStatKey: 'shooting'       },
      { id: 'stickhandling',  name: 'Stickhandling',  shortLabel: 'STK', hexColor: '#00f0ff', playerStatKey: 'stickhandling'  },
      { id: 'passing',        name: 'Passing',         shortLabel: 'PAS', hexColor: '#ffcc00', playerStatKey: 'passing'        },
  ...
  lacrosse: {
    ...
    attributes: [
      { id: 'stick_skills',  name: 'Stick Skills',    shortLabel: 'STK', hexColor: '#00f0ff', playerStatKey: 'stick_skills'  },
  ...
  generic: {
    ...
    attributes: [
      ...
      { id: 'technique', name: 'Technique', shortLabel: 'TEC', hexColor: '#00f0ff', playerStatKey: 'technique' },
