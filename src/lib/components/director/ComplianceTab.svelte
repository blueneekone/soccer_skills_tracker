							...
							<tr>
								...
								<td>
									<select
										...
										class="status-select"
										class:status-red={row.clearanceStatus === 'RED_CARD'}
										class:status-gold={row.clearanceStatus === 'PENDING_SAFESPORT'}
										class:status-green={!row.clearanceStatus || row.clearanceStatus === 'CLEARED'}
									>
