<script lang="ts">
	...
	const voidBlackTheme = [
		...
		{ featureType: "administrative", elementType: "geometry", stylers: [{ color: "#06b6d4" }] },
		...
		{ featureType: "road.highway.controlled_access", elementType: "geometry", stylers: [{ color: "#1e293b" }] },
