<script lang="ts">
	...
	const voidBlackTheme = [
		...
		{ featureType: "road", elementType: "geometry", stylers: [{ color: "#2c3e50" }] }, // Slate-blue roads
		...
		{ featureType: "water", elementType: "geometry", stylers: [{ color: "#00ffff" }] }, // Neon-cyan coastlines/water
