...
<div class="tw-flex tw-flex-col tw-gap-4 tw-font-sans tw-text-slate-200">
	...
	<div class="tw-border-b tw-border-[#334155] tw-pb-3">
		...
		<h3 class="tw-text-base tw-font-bold tw-text-[#fafafa] tw-mt-1">
	...
	<div class="tw-space-y-2">
		<label class="tw-block">
			...
			<input
				...
				class="tw-w-full tw-bg-[#020617] tw-border tw-border-[#334155] tw-rounded-lg tw-px-3 tw-py-2 tw-text-xs tw-text-[#fafafa] focus:tw-border-[#14b8a6] focus:tw-outline-none tw-mt-1"
			/>
		</label>
		...
		<div class="tw-grid tw-grid-cols-2 tw-gap-2">
			<label class="tw-block">
				...
				<select
					...
					class="tw-w-full tw-bg-[#020617] tw-border tw-border-[#334155] tw-rounded-lg tw-px-2 tw-py-2 tw-text-xs tw-text-[#fafafa] focus:tw-border-[#14b8a6] focus:tw-outline-none tw-mt-1"
				>
	...
	<div class="tw-space-y-1">
		...
		<input
			...
			class="tw-w-full tw-bg-[#020617] tw-border tw-border-[#334155] tw-rounded-lg tw-px-3 tw-py-2 tw-text-xs tw-text-[#fafafa] focus:tw-border-[#14b8a6] focus:tw-outline-none"
		/>
	</div>
	...
	<div class="tw-space-y-2">
		<label class="tw-block">
			...
			<textarea
				...
				class="tw-w-full tw-bg-[#020617] tw-border tw-border-[#334155] tw-rounded-lg tw-px-3 tw-py-2 tw-text-xs tw-text-[#fafafa] focus:tw-border-[#14b8a6] focus:tw-outline-none tw-mt-1 tw-resize-none"
			></textarea>
		</label>
	...
	<div class="tw-pt-2 tw-flex tw-flex-col tw-gap-2">
		<button
			type="button"
			class="tw-w-full tw-bg-[#fbbf24] hover:tw-bg-[#fbbf24] tw-text-[#000000] tw-font-mono tw-font-bold tw-py-2.5 tw-px-4 tw-rounded-lg tw-text-xs tw-uppercase tw-transition-colors tw-shadow-[0_0_15px_rgba(251,191,36,0.2)]"
