	...
	>
		...
		>
			{#if deployPhase === 'deploying'}
				...
				<h2 class="tw-mb-6 tw-font-mono tw-text-sm tw-font-bold tw-uppercase tw-tracking-widest tw-text-[#00f0ff]">
					DEPLOYING PLAY...
				</h2>
				...
				<div class="tw-flex tw-items-center tw-justify-center tw-gap-3 tw-rounded-xl tw-border tw-border-[#00f0ff]/20 tw-bg-[#00f0ff]/5 tw-px-4 tw-py-3">
			...
			{:else}
				...
				<h2 class="tw-mb-1 tw-font-mono tw-text-sm tw-font-bold tw-uppercase tw-tracking-widest tw-text-[#00f0ff]">
				...
				<div class="tw-mb-4 tw-h-1.5 tw-w-full tw-overflow-hidden tw-rounded-full tw-bg-white/10">
					<div class="tw-h-full tw-w-full tw-rounded-full tw-bg-gradient-to-r tw-from-[#00f0ff]/50 tw-to-[#00f0ff] tw-shadow-[0_0_12px_rgba(0,240,255,0.6)]"></div>
				</div>

				<div class="tw-mb-6 tw-flex tw-items-center tw-justify-center tw-gap-3 tw-rounded-xl tw-border tw-border-[#00f0ff]/25 tw-bg-[#00f0ff]/10 tw-px-4 tw-py-3">
