	...
	>
		...
		>
			{#if deployPhase === 'deploying'}
				<p class="tw-mb-1 tw-font-mono tw-text-[10px] tw-font-bold tw-uppercase tw-tracking-[0.3em] tw-text-[#fafafa]/25">
				...
				<!-- Progress bar -->
				<div class="tw-mb-2 tw-h-1.5 tw-w-full tw-overflow-hidden tw-rounded-full tw-tw-bg-[#0f172a]/10 tw-shadow-[inset_0_1px_2px_rgba(0,0,0,0.5)]">
					<div
				...
				<p class="tw-mb-6 tw-font-mono tw-text-xs tw-text-[#fafafa]/35">
				...
				<div class="tw-flex tw-items-center tw-justify-center tw-gap-3 tw-rounded-xl tw-border tw-border-[#14b8a6]/20 tw-bg-[#14b8a6]/5 tw-px-4 tw-py-3">
					<span class="tw-font-mono tw-text-xs tw-font-bold tw-uppercase tw-tracking-widest tw-text-[#fafafa]/40">XP BOUNTY</span>
			...
			{:else}
				...
				<p class="tw-mb-5 tw-font-mono tw-text-[10px] tw-tracking-widest tw-text-[#fafafa]/25">
					CARTRIDGE {deployCartridgeId} · CONFIRMED
				</p>

				<div class="tw-mb-4 tw-h-1.5 tw-w-full tw-overflow-hidden tw-rounded-full tw-tw-bg-[#0f172a]/10">
				...
				<div class="tw-mb-6 tw-flex tw-items-center tw-justify-center tw-gap-3 tw-rounded-xl tw-border tw-border-[#14b8a6]/25 tw-bg-[#14b8a6]/10 tw-px-4 tw-py-3">
					<span class="tw-font-mono tw-text-xs tw-font-bold tw-uppercase tw-tracking-widest tw-text-[#fafafa]/40">XP AWARDED</span>
					<span class="tw-font-mono tw-text-xl tw-font-bold tw-text-[#14b8a6]">+{deployXpBounty}</span>
				</div>

				<button
					type="button"
					class="tw-pointer-events-auto tw-w-full tw-rounded-full tw-border tw-border-white/15 tw-tw-bg-[#0f172a]/5 tw-py-2.5 tw-font-mono tw-text-xs tw-font-bold tw-uppercase tw-tracking-widest tw-text-[#fafafa]/50 tw-transition-all hover:tw-border-white/30 hover:tw-tw-bg-[#0f172a]/10 hover:tw-text-[#fafafa]/90"
					onclick={() => onClose?.()}
				>
					CLOSE
				</button>
