...
<div class="coach-tac-z3-stage tw-absolute tw-inset-0 tw-flex tw-items-center tw-justify-center tw-min-w-0">
	<div
		class="coach-tac-z3-pitch tw-relative tw-overflow-visible tw-min-w-0"
		style={isHalfField ? "aspect-ratio: 8/9; height: calc(100vh - 5rem); max-height: calc(100vh - 5rem); max-width: calc((100vh - 5rem) * 8 / 9); width: auto;" : "aspect-ratio: 16/9; width: 100%; max-width: calc((100vh - 2rem) * 16 / 9);"}
	>
