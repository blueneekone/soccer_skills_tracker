...
<g transform="translate({hudRoute.x1}, {hudRoute.y1 - 54})" pointer-events="all">
	...
	<foreignObject x="-100" y="-20" width="200" height="42">
		<div
			...
			class="tw-z-[60] tw-box-border tw-inline-flex tw-items-center tw-gap-2 tw-rounded-xl tw-border tw-border-[#00f0ff]/50 tw-bg-[#050505]/95 tw-px-3 tw-py-2 tw-font-mono tw-text-[10px] tw-text-[#00f0ff] tw-backdrop-blur-md tw-overflow-visible"
			onpointerdown={(e) => e.stopPropagation()}
		>
			<span class="tw-tracking-wide">HOLD: {(hudRoute.delay / 1000).toFixed(1)}s</span>
			<button
				type="button"
				class="tw-shrink-0 tw-rounded-full tw-border tw-border-[#00f0ff]/60 tw-bg-black/50 tw-px-2 tw-py-0.5 tw-font-mono tw-text-[10px] tw-text-[#00f0ff] tw-transition-colors hover:tw-bg-[#00f0ff]/15"
