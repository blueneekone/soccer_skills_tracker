	...
	<div class="stw__grid">
		<section class="stw__panel" aria-labelledby="stw-roster">
			...
			<div class="stw__tablewrap">
				<div class="tw-border tw-border-[#334155] tw-bg-[#0f172a] tw-p-4 tw-min-w-0 tw-overflow-x-auto"><table class="tw-w-full tw-font-mono tw-text-sm stw__table" aria-label="Roster">
					<thead>
						<tr>
