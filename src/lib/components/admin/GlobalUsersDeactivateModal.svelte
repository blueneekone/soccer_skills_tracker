...
>
	...
	>
		...
		<footer class="gu-deactivate-card__foot">
			...
			<button type="button" class="btn-primary tw-bg-[#f59e0b] hover:tw-bg-[#f59e0b] tw-text-[#FAFAFA] tw-px-[clamp(16px,2vw,24px)] tw-py-2 tw-text-sm tw-font-bold disabled:tw-opacity-50 disabled:tw-cursor-not-allowed tw-flex tw-items-center tw-gap-1.5" onclick={onConfirm} disabled={busy || isSelf}>
