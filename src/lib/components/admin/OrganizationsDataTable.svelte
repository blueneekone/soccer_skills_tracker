...
<div class="v-table-wrap z2-panel tw-overflow-x-auto tw-border tw-border-slate-800 tw-bg-[var(--color-navy-slate)] tw-rounded-none tw-min-w-0">
	<table class="v-table tw-w-full tw-border-collapse tw-border-0 tw-rounded-none tw-min-w-0" aria-label="Organizations">
		<thead>
			<tr>
				<th class="tw-px-4 tw-py-3 tw-bg-[#0B0F19] tw-text-left tw-font-semibold tw-text-xs tw-uppercase tw-tracking-wider tw-text-[#A1A1AA] telemetry-readout" scope="col" aria-label="Logo"></th>
				<th class="tw-px-4 tw-py-3 tw-bg-[#0B0F19] tw-text-left tw-font-semibold tw-text-xs tw-uppercase tw-tracking-wider tw-text-[#A1A1AA] telemetry-readout" scope="col">Organization</th>
				<th class="tw-px-4 tw-py-3 tw-bg-[#0B0F19] tw-text-left tw-font-semibold tw-text-xs tw-uppercase tw-tracking-wider tw-text-[#A1A1AA] telemetry-readout" scope="col">Sport</th>
				<th class="tw-px-4 tw-py-3 tw-bg-[#0B0F19] tw-text-left tw-font-semibold tw-text-xs tw-uppercase tw-tracking-wider tw-text-[#A1A1AA] telemetry-readout" scope="col">License</th>
				<th class="tw-px-4 tw-py-3 tw-bg-[#0B0F19] tw-text-left tw-font-semibold tw-text-xs tw-uppercase tw-tracking-wider tw-text-[#A1A1AA] telemetry-readout" scope="col">Director</th>
				<th class="tw-px-4 tw-py-3 tw-bg-[#0B0F19] tw-text-left tw-font-semibold tw-text-xs tw-uppercase tw-tracking-wider tw-text-[#A1A1AA] telemetry-readout" scope="col">Compliance</th>
				<th class="tw-px-4 tw-py-3 tw-bg-[#0B0F19] tw-text-left tw-font-semibold tw-text-xs tw-uppercase tw-tracking-wider tw-text-[#A1A1AA] telemetry-readout" scope="col" aria-label="Actions"></th>
			</tr>
		</thead>
		<tbody>
			{#if clubsLoading}
				<tr>
					<td colspan="7" class="v-td-empty tw-px-4 tw-py-2.5 tw-border-t tw-border-slate-800 tw-text-[#D4D4D8] tw-whitespace-normal tw-min-w-0 telemetry-readout"> aria-busy="true">
						Loading organizations…
					</td>
				</tr>
			{:else if pagedClubs.length === 0}
				<tr>
					<td colspan="7" class="v-td-empty tw-px-4 tw-py-2.5 tw-border-t tw-border-slate-800 tw-text-[#D4D4D8] tw-whitespace-normal tw-min-w-0 telemetry-readout">>
						{totalClubs === 0
			...
			{:else}
				{#each pagedClubs as cl (cl.id)}
					...
					<tr class="v-tr">
						<td class="tw-px-4 tw-py-2.5 tw-border-t tw-border-slate-800 tw-text-[#D4D4D8] tw-truncate tw-min-w-0 telemetry-readout">
						...
						<td class="tw-px-4 tw-py-2.5 tw-border-t tw-border-slate-800 tw-text-[#D4D4D8] tw-whitespace-normal tw-break-words tw-min-w-0 telemetry-readout">
