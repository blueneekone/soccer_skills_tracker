...
<div class="v-table-wrap z2-panel tw-overflow-x-auto tw-border tw-border-slate-800 tw-bg-[var(--color-navy-slate)] tw-rounded-none tw-min-w-0">
	<div class="tw-border tw-border-[#334155] tw-bg-[#0f172a] tw-p-4 tw-min-w-0 tw-overflow-x-auto"><table class="tw-w-full tw-font-mono tw-text-sm v-table tw-border-collapse tw-border-0 tw-rounded-none tw-min-w-0" aria-label="Organizations">
		<thead>
			<tr>
