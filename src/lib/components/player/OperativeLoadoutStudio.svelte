...
<section class="ols-root player-dossier-root" aria-label="Operative loadout studio">
	<div class="ols-grid bento-grid bento-grid--12col bento-grid--liquid tw-grid tw-grid-cols-1 lg:tw-grid-cols-12 tw-font-mono">
		{#if playerEmailKey}
		...
		<div class="ols-picker-panel bento-span-12 tw-min-w-0">
			...
			<div class="ols-picker-body">
				...
				<button
					type="button"
					class="ols-sync-identity qa-mono tw-font-mono"
