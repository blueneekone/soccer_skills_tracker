...
describe('Phase 7 · G7 — ROADMAP', () => {
	it('ROADMAP marks G7 Done with playerHudSprint256 proof', () => {
		expect(roadmapSrc).toMatch(/\|\s*\*\*G7\*\*\s*\|\s*\*\*Done\*\*/);
		expect(roadmapSrc).toMatch(/playerHudSprint256\.test\.ts/);
	});
});
