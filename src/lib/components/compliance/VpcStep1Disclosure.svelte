...
<div class="tw-rounded-[24px] tw-border tw-border-[#334155] tw-bg-[#0f172a] tw-p-6 tw-shadow-2xl tw-mb-6">
	<div class="tw-flex tw-items-center tw-mb-8">
		<button type="button" class="tw-w-8 tw-h-8 tw-bg-[#000000]/50 tw-border tw-border-[#334155] tw-rounded-lg tw-flex tw-items-center tw-justify-center tw-text-[#94a3b8] hover:tw-text-[#fafafa] tw-transition-colors tw-mr-4" onclick={cancelWizard} aria-label="Cancel">
			<Icon name={"nav.arrow-left" as IconName} size={14} />
		</button>
		<div class="tw-flex tw-items-center tw-gap-2 tw-flex-1">
			<span class="tw-w-6 tw-h-6 tw-rounded-full tw-bg-[#f59e0b] tw-text-[#000000] tw-flex tw-items-center tw-justify-center tw-font-mono tw-text-xs tw-font-bold">1</span>
	...
	<h2 class="tw-font-sans tw-text-xl tw-font-semibold tw-tracking-tight tw-text-[#fafafa] tw-mb-2">COPPA 2.0 Verifiable Parental Consent</h2>
	<p class="tw-text-[#94a3b8] tw-font-sans tw-text-sm tw-mb-6">You are consenting on behalf of <strong class="tw-text-[#fafafa]">{activePlayerEmail}</strong>. Read the full disclosure below, then scroll to the bottom to continue.</p>
	...
	<div class="tw-bg-[#1e293b] tw-rounded-lg tw-border tw-border-[#334155] tw-h-64 tw-overflow-y-auto tw-p-6 tw-mb-6 tw-text-sm tw-text-[#cbd5e1] tw-leading-relaxed prose prose-invert prose-p:tw-my-2 prose-ul:tw-my-2" role="document" bind:this={disclosureEl} onscroll={onDisclosureScroll}>
		<h4 class="tw-text-[#fafafa] tw-font-sans tw-font-semibold tw-text-base tw-mb-2">What data we collect</h4>
		...
		<h4 class="tw-text-[#fafafa] tw-font-sans tw-font-semibold tw-text-base tw-mt-6 tw-mb-2">How we use this data</h4>
		...
		<h4 class="tw-text-[#fafafa] tw-font-sans tw-font-semibold tw-text-base tw-mt-6 tw-mb-2">Data retention and deletion</h4>
		...
		<h4 class="tw-text-[#fafafa] tw-font-sans tw-font-semibold tw-text-base tw-mt-6 tw-mb-2">Your rights under COPPA &amp; FERPA</h4>
		...
		<h4 class="tw-text-[#fafafa] tw-font-sans tw-font-semibold tw-text-base tw-mt-6 tw-mb-2">Policy version</h4>
