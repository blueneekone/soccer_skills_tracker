...
<div class="tw-rounded-[24px] tw-border tw-border-[#334155] tw-bg-[#0f172a] tw-p-6 tw-shadow-2xl tw-mb-6">
	<div class="tw-flex tw-items-center tw-mb-8">
		<button type="button" class="tw-w-8 tw-h-8 tw-bg-[#000000]/50 tw-border tw-border-[#334155] tw-rounded-lg tw-flex tw-items-center tw-justify-center tw-text-[#94a3b8] hover:tw-text-[#fafafa] tw-transition-colors tw-mr-4" onclick={() => wizardStage = 'step1'} aria-label="Back">
		...
		<div class="tw-flex tw-items-center tw-gap-2 tw-flex-1">
			...
			<span class="tw-w-6 tw-h-6 tw-rounded-full tw-bg-[#f59e0b] tw-text-[#000000] tw-flex tw-items-center tw-justify-center tw-font-mono tw-text-xs tw-font-bold">2</span>
	...
	<h2 class="tw-font-sans tw-text-xl tw-font-semibold tw-tracking-tight tw-text-[#fafafa] tw-mb-2">Step 2 — Consent Assertions</h2>
	...
	<div class="tw-space-y-4 tw-mb-8">
		<label class="tw-flex tw-items-start tw-gap-4 tw-bg-[#1e293b] tw-rounded-lg tw-border tw-border-[#334155] tw-p-4 tw-cursor-pointer hover:tw-border-[#f59e0b] tw-transition-colors">
			...
			<div>
				<div class="tw-flex tw-items-center tw-gap-2 tw-mb-1">
					<strong class="tw-text-[#fafafa] tw-font-sans">Workout &amp; training data</strong>
		...
		<label class="tw-flex tw-items-start tw-gap-4 tw-bg-[#1e293b] tw-rounded-lg tw-border tw-border-[#334155] tw-p-4 tw-cursor-pointer hover:tw-border-[#f59e0b] tw-transition-colors">
			...
			<div>
				<div class="tw-flex tw-items-center tw-gap-2 tw-mb-1">
					<strong class="tw-text-[#fafafa] tw-font-sans">Identity &amp; roster data</strong>
					<span class="tw-bg-[#f59e0b]/10 tw-border tw-border-[#f59e0b]/40 tw-text-[#f59e0b] tw-px-2 tw-py-0.5 tw-rounded tw-font-mono tw-text-[9px] tw-uppercase tw-tracking-widest">Required</span>
				</div>
		...
		<label class="tw-flex tw-items-start tw-gap-4 tw-bg-[#1e293b] tw-rounded-lg tw-border tw-border-[#334155] tw-p-4 tw-cursor-pointer hover:tw-border-[#64748b] tw-transition-colors">
			...
			<div>
				<div class="tw-flex tw-items-center tw-gap-2 tw-mb-1">
					<strong class="tw-text-[#fafafa] tw-font-sans">Performance analytics</strong>
		...
		<label class="tw-flex tw-items-start tw-gap-4 tw-bg-[#1e293b] tw-rounded-lg tw-border tw-border-[#334155] tw-p-4 tw-cursor-pointer hover:tw-border-[#64748b] tw-transition-colors">
			...
			<div>
				<div class="tw-flex tw-items-center tw-gap-2 tw-mb-1">
					<strong class="tw-text-[#fafafa] tw-font-sans">In-app communications</strong>
					<span class="tw-bg-[#334155] tw-text-[#94a3b8] tw-px-2 tw-py-0.5 tw-rounded tw-font-mono tw-text-[9px] tw-uppercase tw-tracking-widest">Optional</span>
				</div>
		...
		<label class="tw-flex tw-items-start tw-gap-4 tw-bg-[#1e293b] tw-rounded-lg tw-border tw-border-[#334155] tw-p-4 tw-cursor-pointer hover:tw-border-[#64748b] tw-transition-colors">
			...
			<div>
				<div class="tw-flex tw-items-center tw-gap-2 tw-mb-1">
					<strong class="tw-text-[#fafafa] tw-font-sans">Sponsor &amp; partner updates</strong>
					<span class="tw-bg-[#334155] tw-text-[#94a3b8] tw-px-2 tw-py-0.5 tw-rounded tw-font-mono tw-text-[9px] tw-uppercase tw-tracking-widest">Optional</span>
				</div>
