...
{#if engine.toastMsg}
	<div class="tw-bg-[#0f172a] tw-border tw-border-[#14b8a6] tw-text-[#14b8a6] tw-px-4 tw-py-2 tw-rounded-lg tw-font-mono tw-text-sm tw-mb-4" role="status" aria-live="polite">
		{engine.toastMsg}
	</div>
{/if}
...
<div class="tw-flex tw-flex-col tw-gap-4 tw-mb-4 tw-w-full">
	...
	<div class="tw-flex tw-flex-col lg:tw-flex-row tw-justify-between tw-items-stretch tw-gap-4 tw-border-b tw-border-[#334155] tw-pb-4">
		...
		<div class="tw-flex tw-gap-2 tw-flex-wrap">
			...
			<div class="vanguard-panel tw-px-4 tw-py-2 tw-flex tw-flex-col tw-items-end tw-justify-center tw-min-w-[100px]">
				<span class="tw-text-[#FAFAFA] tw-text-xl tw-font-bold tw-font-mono">{engine.counts.total}</span>
				<span class="tw-text-[#94A3B8] tw-text-[10px] tw-font-mono tw-uppercase tw-tracking-widest">TOTAL</span>
			</div>
			<!-- Cleared -->
			<div class="vanguard-panel tw-px-4 tw-py-2 tw-flex tw-flex-col tw-items-end tw-justify-center tw-min-w-[100px] tw-border-l-2 tw-border-[#14b8a6]">
				<span class="tw-text-[#14b8a6] tw-text-xl tw-font-bold tw-font-mono">{engine.counts.cleared}</span>
				<span class="tw-text-[#14b8a6]/70 tw-text-[10px] tw-font-mono tw-uppercase tw-tracking-widest">CLEARED</span>
			</div>
			<!-- Pending -->
			<div class="vanguard-panel tw-px-4 tw-py-2 tw-flex tw-flex-col tw-items-end tw-justify-center tw-min-w-[100px] tw-border-l-2 tw-border-[#f59e0b]">
				<span class="tw-text-[#f59e0b] tw-text-xl tw-font-bold tw-font-mono">{engine.counts.pending}</span>
				<span class="tw-text-[#f59e0b]/70 tw-text-[10px] tw-font-mono tw-uppercase tw-tracking-widest">PENDING</span>
			</div>
			<!-- Flagged -->
			<div class="vanguard-panel tw-px-4 tw-py-2 tw-flex tw-flex-col tw-items-end tw-justify-center tw-min-w-[100px] tw-border-l-2 tw-border-[var(--vanguard-red,#f43f5e)]">
				<span class="tw-text-[var(--vanguard-red,#f43f5e)] tw-text-xl tw-font-bold tw-font-mono">{engine.counts.flagged}</span>
				<span class="tw-text-[var(--vanguard-red,#f43f5e)]/70 tw-text-[10px] tw-font-mono tw-uppercase tw-tracking-widest">FLAGGED</span>
			</div>
		</div>
	</div>
	...
	<div class="v-admin-toolbar tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-gap-4">
		...
		<div class="tw-flex tw-items-center">
			<div class="tw-flex tw-items-center tw-gap-2 tw-bg-[#0B0F19] tw-border tw-border-[#334155] tw-px-3 tw-py-2 tw-rounded-none">
