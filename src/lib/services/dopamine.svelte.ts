...
export type DopamineKind = 'drill' | 'grit' | 'levelUp' | 'matchWin' | 'loadoutUnlock' | 'adminRelief' | 'escrow';
...
const PRESETS: Record<DopamineKind, ConfettiOptions> = {
	...
	matchWin: {
		particleCount: 140,
		spread: 110,
		colors: ['#f8fafc', '#fbbf24', '#22c55e', '#3b82f6'],
		startVelocity: 45,
		gravity: 0.8,
		scalar: 1.1,
		ticks: 300,
	...
	escrow: {
		particleCount: 150,
		spread: 100,
		colors: ['#fbbf24', '#f59e0b', '#0f172a', '#334155'],
		startVelocity: 40,
		gravity: 0.85,
		scalar: 1.2,
		ticks: 300,
