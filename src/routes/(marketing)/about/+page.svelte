...
<svelte:head>
	<title>About Us — SSTracker</title>
	<meta name="description" content="Discover the team and technology behind SSTracker, the ultimate operating system for elite youth clubs." />
</svelte:head>
...
<div class="tw-flex tw-w-full tw-min-h-dvh tw-flex-col tw-bg-[#000000] tw-text-[#f8fafc] tw-font-sans tw-selection:bg-[#14b8a6] tw-selection:text-[#000000]">
	...
	<header class="tw-max-w-7xl tw-mx-auto tw-w-full tw-px-6 tw-pt-24 tw-pb-16 tw-flex tw-flex-col tw-items-center tw-text-center tw-gap-6">
		<span class="tw-font-mono tw-text-xs tw-font-bold tw-tracking-[0.3em] tw-text-[#f59e0b]">SYS.ABOUT_US</span>
	...
	<section class="st-bento tw-max-w-7xl tw-mx-auto tw-w-full tw-px-6 tw-mb-24">
		<div class="tw-flex tw-flex-col tw-items-center tw-text-center tw-mb-12">
			...
			<p class="tw-text-[#94a3b8] tw-mt-4 tw-max-w-2xl" style="font-family: 'Switzer', sans-serif;">
				The legacy youth sports industry is fractured. Clubs are forced to stitch together 6 different apps just to operate. We built a unified Nexus.
			</p>
		</div>
		...
		<div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-12 tw-gap-6">
			...
			<div class="tw-col-span-1 md:tw-col-span-4 tw-bg-[#0f172a] tw-border tw-border-[#ef4444]/30 tw-p-8 tw-relative tw-overflow-hidden" style="filter: drop-shadow(0 15px 30px rgba(0,0,0,0.8)) drop-shadow(0 4px 12px rgba(239,68,68,0.05));">
				...
				<div class="tw-flex tw-items-center tw-gap-2 tw-mb-6">
					<Icon name={"status.x-circle" as IconName} size={24} class="tw-text-[#ef4444]" />
					<h3 class="tw-font-mono tw-text-sm tw-font-bold tw-tracking-widest tw-text-[#ef4444] tw-uppercase" style="font-family: 'Geist Mono', monospace;">The Frankenstein Stack</h3>
				</div>

				<ul class="tw-flex tw-flex-col tw-gap-4 tw-text-sm tw-text-[#cbd5e1] tw-font-mono">
					<li class="tw-flex tw-items-center tw-justify-between tw-border-b tw-border-[#334155] tw-pb-2">
						<span>Scheduling</span>
						<span class="tw-text-[#64748b]">App A</span>
					</li>
					<li class="tw-flex tw-items-center tw-justify-between tw-border-b tw-border-[#334155] tw-pb-2">
						<span>Billing</span>
						<span class="tw-text-[#64748b]">App B</span>
					</li>
					<li class="tw-flex tw-items-center tw-justify-between tw-border-b tw-border-[#334155] tw-pb-2">
						<span>Comms</span>
						<span class="tw-text-[#64748b]">App C</span>
					</li>
					<li class="tw-flex tw-items-center tw-justify-between tw-border-b tw-border-[#334155] tw-pb-2">
						<span>Evaluation</span>
						<span class="tw-text-[#64748b]">App D</span>
					</li>
					<li class="tw-flex tw-items-center tw-justify-between tw-border-b tw-border-[#334155] tw-pb-2">
						<span>Waivers</span>
						<span class="tw-text-[#64748b]">Paper/App E</span>
					</li>
					<li class="tw-flex tw-items-center tw-justify-between tw-pt-2 tw-text-[#ef4444] tw-font-bold">
			...
			<div class="tw-col-span-1 md:tw-col-span-8 tw-bg-[#0f172a] tw-border tw-border-[#14b8a6]/50 tw-p-8 tw-relative tw-flex tw-flex-col" style="filter: drop-shadow(0 15px 30px rgba(0,0,0,0.8)) drop-shadow(0 4px 12px rgba(20,184,166,0.05));">
				<div class="tw-absolute tw-top-0 tw-right-0 tw-w-16 tw-h-16 tw-border-t-2 tw-border-r-2 tw-border-[#14b8a6] tw-opacity-50"></div>

				<div class="tw-flex tw-items-center tw-gap-2 tw-mb-6">
					<Icon name={"status.shield-check" as IconName} size={28} class="tw-text-[#14b8a6]" />
					<h3 class="tw-font-mono tw-text-lg tw-font-bold tw-tracking-widest tw-text-[#14b8a6] tw-uppercase" style="font-family: 'Geist Mono', monospace;">SSTracker Unified Ecosystem</h3>
				</div>

				<p class="tw-text-[#94a3b8] tw-text-base tw-leading-relaxed tw-mb-8" style="font-family: 'Switzer', sans-serif;">
				...
				<div class="tw-flex tw-flex-wrap tw-gap-4 tw-mt-auto child-flex-basis">
					...
					<div class="tw-bg-[#020617] tw-border tw-border-[#334155] tw-p-4 tw-flex tw-flex-col tw-gap-2 tw-w-[calc(50%-0.5rem)] md:tw-w-[calc(33.333%-0.7rem)]">
						<Icon name={"game.rocket" as IconName} size={20} class="tw-text-[#f59e0b]" />
	...
	<section class="tw-max-w-5xl tw-mx-auto tw-w-full tw-px-6 tw-mb-24">
		<div class="tw-bg-[#0f172a] tw-border tw-border-[#334155] tw-p-8 md:tw-p-12 tw-flex tw-flex-col md:tw-flex-row tw-gap-12 tw-items-center md:tw-items-start" style="filter: drop-shadow(0 15px 30px rgba(0,0,0,0.8)) drop-shadow(0 4px 12px rgba(20,184,166,0.05));">
			...
			<div class="tw-shrink-0 tw-w-48 tw-h-48 tw-rounded-sm tw-bg-[#020617] tw-border-2 tw-border-dashed tw-border-[#334155] tw-flex tw-flex-col tw-items-center tw-justify-center tw-relative tw-group">
				<Icon name={"user.profile" as IconName} size={48} class="tw-text-[#475569] tw-mb-2 group-hover:tw-text-[#f59e0b] tw-transition-colors tw-duration-300" />
				<span class="tw-font-mono tw-text-[10px] tw-text-[#64748b] tw-uppercase tw-tracking-widest">Awaiting Upload</span>
				<div class="tw-absolute -tw-bottom-3 tw-bg-[#0f172a] tw-px-2 tw-border tw-border-[#334155] tw-font-mono tw-text-[9px] tw-text-[#f59e0b] tw-tracking-widest">HEADSHOT.SLOT</div>
			</div>
			...
			<div class="tw-flex-1 tw-text-center md:tw-text-left">
				...
				<span class="tw-font-mono tw-text-sm tw-text-[#f59e0b] tw-tracking-widest tw-uppercase tw-block tw-mb-6">Chief Executive Officer</span>
				...
				<p class="tw-text-[#94a3b8] tw-text-base tw-leading-relaxed" style="font-family: 'Switzer', sans-serif;">
					"Our mission is to arm elite academies with a platform that doesn't just manage schedules, but actively engineers dopamine-driven development while enforcing strict, uncompromising compliance. We are building the infrastructure for the next generation of champions."
				</p>

				<div class="tw-mt-8 tw-flex tw-items-center tw-justify-center md:tw-justify-start tw-gap-4">
					<a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" class="tw-font-mono tw-text-xs tw-text-[#64748b] hover:tw-text-[#f59e0b] tw-uppercase tw-tracking-widest tw-transition-colors tw-duration-150 tw-flex tw-items-center tw-gap-2">
