...
<div class="ty-root tw-mx-auto tw-max-w-lg tw-px-4 tw-py-16 tw-text-slate-100">
	...
	{:else}
		...
		<dl class="ty-facts tw-mt-6 tw-space-y-2 tw-rounded-sm tw-border tw-border-[#334155] tw-bg-[#0f172a] tw-p-4 tw-text-sm">
			...
			{#if program.spotsRemaining != null}
				<div class="tw-flex tw-justify-between tw-gap-3">
					...
					<dd class="tw-font-mono tw-font-bold tw-text-[#f59e0b]">{program.spotsRemaining}</dd>
				</div>
			{/if}
		...
		{#if !program.registrationOpen}
			<p class="tw-mt-6 tw-text-[#fbbf24] tw-font-mono tw-text-sm">Registration is closed for this tryout.</p>
		{:else}
			<form
			...
			{#if registrationId}
				<section class="ty-rsvp tw-mt-8 tw-rounded-sm tw-border tw-border-[#334155] tw-bg-[#0f172a] tw-p-4">
					...
					<p class="tw-mt-2 tw-text-sm tw-text-slate-300">
						Confirmation code: <code class="tw-font-mono tw-text-[#f59e0b] tw-font-bold">{registrationId}</code>
					</p>
				...
				{#if pipelineStatus === 'offered'}
					<section class="ty-rsvp tw-mt-6 tw-rounded-sm tw-border tw-border-[#f59e0b] tw-bg-[#0f172a] tw-p-4">
						<h2 class="tw-m-0 tw-text-sm tw-font-bold tw-uppercase tw-tracking-wide tw-text-[#f59e0b]">
							Roster offer
						</h2>
						<p class="tw-mt-2 tw-text-sm tw-text-slate-300">
