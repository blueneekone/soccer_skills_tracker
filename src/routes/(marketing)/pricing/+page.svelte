...
<div class="tw-flex tw-w-full tw-min-h-dvh tw-flex-col tw-bg-[#000000] tw-text-[#f8fafc] tw-font-sans tw-selection:bg-[#14b8a6] tw-selection:text-[#000000] tw-pb-24">
	...
	<header class="tw-max-w-7xl tw-mx-auto tw-w-full tw-px-6 tw-pt-24 tw-pb-16 tw-flex tw-flex-col tw-items-center tw-text-center tw-gap-6">
		<span class="tw-font-mono tw-text-xs tw-font-bold tw-tracking-[0.3em] tw-text-[#f59e0b]">LIVE LICENSING & BILLING</span>
	...
	<section class="tw-max-w-4xl tw-mx-auto tw-w-full tw-px-6 tw-flex tw-justify-center">
		<a href="/login" class="tw-bg-[#f59e0b] tw-text-[#000000] hover:tw-bg-[#f59e0b]/90 tw-px-10 tw-py-4 tw-font-mono tw-font-bold tw-text-sm tw-uppercase tw-tracking-widest tw-transition-all tw-duration-150 tw-inline-flex tw-items-center tw-gap-3 tw-text-center tw-rounded-sm active:tw-scale-[0.98] tw-shadow-[0_0_25px_rgba(251,191,36,0.25)]">
			Deploy Your Club
