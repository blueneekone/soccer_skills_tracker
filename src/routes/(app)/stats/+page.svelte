...
<div class="ec-page ec-player-stats view-section">
	...
	<div class="tw-grid tw-grid-cols-1 xl:tw-grid-cols-12 tw-gap-6">
		<div
			class="tw-min-w-0 tw-flex tw-flex-col tw-gap-6"
			class:xl:tw-col-span-8={isPlayerRole}
			class:xl:tw-col-span-12={!isPlayerRole}
		>
			{#if isPlayerRole}
	...
	<div class="bento-section">
		<div class="card">
			...
			<div class="card-body p-0 stats-table-wrap">
