...
<style>
  ...
  .vp-badge { font-size: 0.52rem; font-weight: 700; letter-spacing: 0.2em; color: rgba(0,240,255,0.45); display: block; margin-bottom: 0.25rem; }
  ...
  .vp-count-pill { display: inline-flex; align-items: center; gap: 0.4rem; padding: 0.3rem 0.8rem; border: 1px solid rgba(0,240,255,0.25); background: rgba(0,240,255,0.05); border-radius: 999px; font-size: 0.6rem; font-weight: 700; letter-spacing: 0.14em; color: rgba(0,240,255,0.7); }
  .vp-count-dot { width: 6px; height: 6px; border-radius: 50%; background: #00f0ff; box-shadow: 0 0 6px #00f0ff; animation: vpPulse 1.4s ease-in-out infinite; }

  /* States */
  .vp-loading { display: flex; align-items: center; gap: 0.75rem; padding: 2rem; justify-content: center; font-size: 0.65rem; letter-spacing: 0.14em; color: rgba(0,240,255,0.45); }
  .vp-empty { display: flex; flex-direction: column; align-items: center; gap: 0.65rem; padding: 2.5rem; text-align: center; }
  .vp-empty__icon { width: 2.5rem; height: 2.5rem; color: rgba(0,240,255,0.4); }
  ...
  .vp-grid-head {
    ...
    color: rgba(0,240,255,0.3); border-bottom: 1px solid rgba(0,240,255,0.08);
  }
  ...
  .vp-cyan        { color: rgba(0,240,255,0.65); }

  /* TTL */
  .vp-ttl         { font-size: 0.65rem; font-weight: 700; color: rgba(0,240,255,0.7); letter-spacing: 0.08em; }
  ...
  .vp-btn--nudge { background: rgba(0,240,255,0.05); border-color: rgba(0,240,255,0.2); color: rgba(0,240,255,0.7); }
  .vp-btn--nudge:hover:not(:disabled) { background: rgba(0,240,255,0.1); border-color: rgba(0,240,255,0.5); }
  ...
  .vp-btn--confirm { background: rgba(0,240,255,0.06); border-color: rgba(0,240,255,0.4); color: #00f0ff; padding: 0.5rem 1.25rem; }
  .vp-btn--confirm:hover:not(:disabled) { background: rgba(0,240,255,0.14); box-shadow: 0 0 18px rgba(0,240,255,0.15); }

  /* Spinners */
  .vp-spinner { display: inline-block; width: 1rem; height: 1rem; border: 2px solid rgba(0,240,255,0.15); border-top-color: rgba(0,240,255,0.7); border-radius: 50%; animation: vpSpin 0.7s linear infinite; }
  ...
  .vp-modal__email  { display: block; font-size: 0.62rem; color: rgba(0,240,255,0.55); margin-top: 0.15rem; }
  ...
  .vp-modal__check strong { color: rgba(0,240,255,0.75); }
  .vp-checkbox { accent-color: #00f0ff; margin-top: 0.2rem; flex-shrink: 0; }
