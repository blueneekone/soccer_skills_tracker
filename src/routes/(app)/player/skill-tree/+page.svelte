...
<div class="pd-page-root player-dossier-root st-page tw-h-[100dvh] tw-min-w-0 tw-overflow-hidden tw-flex tw-flex-col tw-text-white tw-font-mono player-os-root" style="background: var(--pd-bg);">
