...
<main class="tw-bg-[#000000] tw-h-[100dvh] tw-overflow-hidden tw-text-[#fafafa] tw-font-sans tw-p-6 lg:tw-p-8 tw-flex tw-flex-col tw-gap-8 player-dossier-root player-hud-root pd-content-wrap pd-route-stack">
