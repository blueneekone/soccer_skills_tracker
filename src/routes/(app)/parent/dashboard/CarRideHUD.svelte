...
{#if engine.shouldIntercept}
	...
	>
		...
		>
			<div
				class="tw-w-full tw-max-w-md tw-flex tw-flex-col tw-gap-6 tw-border tw-border-[#1E293B] tw-bg-[#0B0F19]/95 tw-backdrop-blur-sm tw-p-8"
			...
			>
				...
				<button
					...
					class="tw-w-full tw-font-mono tw-text-[10px] tw-tracking-widest tw-uppercase tw-border tw-border-[#ff0055] tw-text-[#ff0055] tw-bg-[#ff0055]/10 tw-px-6 tw-py-4 tw-transition-all tw-duration-200
