...
<div class="waiver-console-arena tw-h-[100dvh] tw-overflow-hidden tw-bg-[#0B0F19] tw-text-[#fafafa] tw-p-6 tw-flex tw-flex-col tw-items-center tw-justify-center">
	<div class="waiver-wrapper tw-max-w-2xl tw-w-full tw-bg-[#0F172A] tw-border tw-border-[#1E293B] tw-p-8 tw-rounded-[24px] tw-shadow-2xl">
		<div class="tw-flex tw-items-center tw-justify-center tw-gap-2 tw-mb-2">
			<Icon name={"status.shield-check" as IconName} size={24} class="tw-text-[#f59e0b]" />
			<h1 class="tw-text-2xl tw-font-bold tw-tracking-tight tw-text-center tw-uppercase tw-text-[#fafafa]" style="font-family: 'Geist Sans', sans-serif;">
				SPORT-HAZARD LIABILITY WAIVER
			</h1>
		</div>
		<h2 class="tw-text-xs tw-text-[#f59e0b] tw-font-mono tw-uppercase tw-tracking-widest tw-mb-6 tw-text-center">
		...
		<div class="document-viewer tw-border tw-border-[#1E293B] tw-bg-[#0B0F19] tw-p-5 tw-h-64 tw-overflow-y-scroll tw-text-sm tw-text-slate-300 tw-leading-relaxed tw-mb-6 tw-rounded-2xl">
			<h3 class="tw-font-bold tw-text-[#fafafa] tw-mb-2 tw-flex tw-items-center tw-gap-2">
		...
		<div class="granular-switches tw-border-t tw-border-b tw-border-[#1E293B] tw-py-4 tw-mb-6 tw-space-y-4">
			<div class="switch-item tw-flex tw-items-start tw-justify-between">
				<div class="tw-min-w-0">
					<label for="fan-os-switch" class="tw-font-bold tw-text-sm tw-text-[#fafafa] tw-flex tw-items-center tw-gap-2">
				...
				<input
					...
					class="tw-form-checkbox tw-h-5 tw-w-5 tw-text-[#14b8a6] tw-rounded-none tw-bg-[#000000] tw-border-[#334155] focus:tw-ring-0"
				/>
			</div>

			<div class="switch-item tw-flex tw-items-start tw-justify-between">
				<div class="tw-min-w-0">
					<label for="player-os-switch" class="tw-font-bold tw-text-sm tw-text-[#fafafa] tw-flex tw-items-center tw-gap-2">
						<Icon name={"content.film" as IconName} size={14} class="tw-text-[#14b8a6]" />
		...
		{#if controller.success}
			<div class="tw-bg-[#0B0F19] tw-border tw-border-[#f59e0b]/40 tw-p-5 tw-rounded-none tw-mb-6">
				<p class="tw-text-[#f59e0b] tw-font-bold tw-font-mono tw-text-sm tw-mb-3 tw-flex tw-items-center tw-gap-2">
		...
		{:else}
			<div class="audit-captures tw-space-y-4 tw-mb-6">
				<div>
					...
					<input
						...
						class="tw-w-full tw-bg-[#0B0F19] tw-border tw-border-[#1E293B] tw-p-2.5 tw-font-mono tw-text-sm tw-text-[#fafafa] focus:tw-border-[#14b8a6] focus:tw-outline-none tw-rounded-none"
					/>
				</div>
				...
				<div class="tw-flex tw-items-start tw-gap-3">
					<input
						...
						class="tw-mt-1 tw-h-4 tw-w-4 tw-text-[#f59e0b] tw-bg-[#000000] tw-border-[#334155] focus:tw-ring-0 tw-rounded-none"
					/>
			...
			{#if controller.error}
				<div class="tw-p-3 tw-mb-4 tw-bg-[#f59e0b]/30 tw-border tw-border-red-500/30 tw-flex tw-items-center tw-gap-2">
			...
			<button
				...
				class="tw-w-full tw-bg-[#f59e0b] tw-text-[#000000] tw-font-mono tw-font-bold tw-py-3.5 tw-text-xs tw-tracking-widest tw-uppercase hover:tw-bg-[#fbbf24] tw-transition-all tw-duration-150 disabled:tw-bg-[#1E293B] disabled:tw-text-slate-500 tw-flex tw-items-center tw-justify-center tw-gap-2 tw-rounded-none"
			>
