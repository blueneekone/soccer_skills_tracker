	...
	<div class="waiver-wrapper tw-max-w-2xl tw-w-full tw-bg-[#0F172A] tw-border tw-border-[#1E293B] tw-p-8 tw-rounded-[24px] tw-shadow-2xl">
		...
		{:else}
			...
			<button
				...
				class="tw-w-full tw-bg-[#f59e0b] tw-text-black tw-font-mono tw-font-bold tw-py-3.5 tw-text-xs tw-tracking-widest tw-uppercase hover:tw-bg-[#fbbf24] tw-transition-all tw-duration-150 disabled:tw-bg-[#1E293B] disabled:tw-text-slate-500 tw-flex tw-items-center tw-justify-center tw-gap-2 tw-rounded-none"
			>
