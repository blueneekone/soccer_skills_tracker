...
{#if activeTab === 'executive'}
	<!-- Executive KPI Strip -->
	<div class="bento-grid--12col bento-grid--liquid tw-w-full tw-mb-6">
		{#each engine.strike13Executive.slice(0, 4) as tile}
			<div class="bento-span-3 cc-soc-card dark-form-surface">
	...
	<div class="bento-grid--12col bento-grid--liquid tw-w-full">
		<div class="bento-span-6 tw-flex tw-flex-col">
...
{#if activeTab === 'security'}
	...
	<div class="bento-grid--12col bento-grid--liquid tw-w-full">
		<!-- Playbooks & Queue -->
		<div class="bento-span-8 tw-flex tw-flex-col">
			<div class="tw-bg-[#0B0F19] tw-border tw-border-[#1E293B] tw-rounded-none tw-p-6 tw-flex tw-flex-col tw-h-full">
		...
		<!-- Global Live Feed -->
		<div class="bento-span-4 tw-flex tw-flex-col">
			<div class="cc-feed-shell--soc dark-form-surface tw-bg-[#0B0F19] tw-border tw-border-[#1E293B] tw-rounded-none tw-flex tw-flex-col tw-h-full tw-overflow-hidden">
