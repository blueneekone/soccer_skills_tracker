	...
	{#if engine.isLoading}
		<div class="tw-flex-1 tw-flex tw-items-center tw-justify-center">
			<div class="tw-flex tw-items-center tw-gap-3">
				...
				<p class="tw-font-mono tw-text-sm tw-text-[#f59e0b] tw-tracking-widest tw-animate-pulse">LOADING_TELEMETRY...</p>
			</div>
		</div>
	...
	{:else}
		...
		{#if engine.activeTab === 'overview'}
			...
			<div class="tw-grid tw-grid-cols-12 bento-grid-container tw-mb-6 tw-gap-4" style="grid-template-columns: repeat(auto-fit, minmax(min(100%, clamp(280px, 30vw, 350px)), 1fr));">
				...
				<div class="z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-flex tw-flex-col tw-min-w-0 hover:tw-border-[#f59e0b] hover:tw-shadow-neon-nuclear tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
					...
					<span class="tw-text-4xl tw-font-black tw-text-[#f59e0b]" style="font-family: 'Geist Mono', monospace;">NOMINAL</span>
				</div>
			</div>
			...
			<div class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-12 bento-grid-container tw-gap-4">
				...
				<div class="lg:tw-col-span-8 z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-min-h-[400px] tw-flex tw-flex-col tw-min-w-0 hover:tw-border-[#f59e0b]/50 tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
					<div class="tw-flex tw-items-center tw-justify-between tw-mb-6">
						<h3 class="tw-text-xs tw-font-bold tw-uppercase tw-tracking-widest tw-text-[#f59e0b] tw-flex tw-items-center tw-gap-2" style="font-family: 'Geist Sans', sans-serif;">
					...
					<div class="tw-flex-1 z1-well tw-flex tw-flex-col tw-items-center tw-justify-center tw-min-w-0 tw-p-8 tw-border tw-border-slate-800 tw-bg-[#000000]">
						<Icon name={"data.chart-line" as IconName} size={32} class="tw-text-[#f59e0b] tw-opacity-40 tw-mb-3" />
				...
				<div class="lg:tw-col-span-4 tw-flex tw-flex-col tw-gap-6 tw-min-w-0">
					...
					<div class="tw-flex-1 z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-flex tw-flex-col tw-min-w-0 hover:tw-border-[#f59e0b]/50 tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
			...
			<div class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-12 admin-hud-grid bento-grid-container tw-mt-6 tw-gap-4">
				...
				<div class="global-telemetry-feed lg:tw-col-span-8 z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-min-w-0 hover:tw-border-[#f59e0b]/50 tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
				...
				<div class="system-health-diagnostics lg:tw-col-span-4 z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-min-w-0 hover:tw-border-[#f59e0b]/50 tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
					...
					<div class="tw-text-[#f59e0b] tw-text-xs tw-font-mono" style="font-family: 'Geist Mono', monospace;">All Systems Nominal (100%)</div>
				</div>
			</div>
		{/if}
		...
		{#if engine.activeTab === 'security'}
			<div class="z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-bg-[#0f172a] tw-border tw-border-[#334155]">
				<h3 class="tw-text-xs tw-font-bold tw-uppercase tw-font-sans tw-tracking-widest tw-text-[#f59e0b] tw-mb-6 tw-flex tw-items-center tw-gap-2">
				...
				<div class="tw-mt-4 tw-p-4 z1-well tw-flex tw-items-center tw-justify-between tw-bg-[#000000] tw-border tw-border-[#334155]">
					<div>
						<h4 class="tw-text-sm tw-font-bold tw-text-[#FAFAFA] tw-flex tw-items-center tw-gap-2">
							<Icon name={"sys.ban" as IconName} size={16} class="tw-text-[#f59e0b]" />
