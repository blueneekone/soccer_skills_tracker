	...
	<div class="tw-grid tw-grid-cols-1 xl:tw-grid-cols-12 tw-gap-[clamp(16px,2vw,24px)] tw-w-full tw-min-w-0">
		<div class="xl:tw-col-span-12 tw-min-w-0 tw-flex tw-flex-col tw-break-words tw-whitespace-normal">
			...
			{#if activeTab === 'executive'}
				<!-- Executive KPI Strip -->
				<div class="tw-grid tw-grid-cols-2 lg:tw-grid-cols-4 tw-w-full tw-bg-[#0B0F19] tw-border tw-border-[#334155] tw-rounded-xl tw-mb-6 tw-divide-y sm:tw-divide-y-0 sm:tw-divide-x tw-divide-[#334155]">
				...
				<div class="tw-grid tw-grid-cols-1 xl:tw-grid-cols-12 tw-gap-6 tw-w-full">
					<div class="tw-col-span-1 xl:tw-col-span-6 tw-flex tw-flex-col">
						...
						<div class="tw-bg-[#0B0F19] tw-border tw-border-[#334155] tw-rounded-xl tw-p-6 tw-flex tw-flex-col tw-h-full">
			...
			{#if activeTab === 'growth'}
				<div class="tw-flex tw-flex-col sm:tw-flex-row tw-w-full tw-bg-[#0B0F19] tw-border tw-border-[#334155] tw-rounded-xl tw-mb-6 tw-divide-y sm:tw-divide-y-0 sm:tw-divide-x tw-divide-[#334155]">
			...
			{#if activeTab === 'security'}
				...
				<div class="tw-grid tw-grid-cols-1 xl:tw-grid-cols-12 tw-gap-6 tw-w-full">
						...
						<div class="tw-bg-[#0B0F19] tw-border tw-border-[#334155] tw-rounded-xl tw-p-6 tw-flex tw-flex-col tw-h-full">
							...
							<div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 tw-gap-4">
								{#each engine.socRibbon as ribbon}
									<div class="tw-p-5 tw-bg-[#1E293B] tw-border tw-border-[#334155] tw-rounded-lg">
					...
					<div class="tw-col-span-1 xl:tw-col-span-4 tw-flex tw-flex-col">
						<div class="tw-bg-[#0B0F19] tw-border tw-border-[#334155] tw-rounded-xl tw-flex tw-flex-col tw-h-full tw-overflow-hidden">
							<div class="tw-p-4 tw-border-b tw-border-[#334155] tw-bg-[#0B0F19]">
							...
							<div class="tw-flex-1 tw-overflow-y-auto tw-p-0 tw-flex tw-flex-col tw-h-[280px]">
								...
								{:else}
									{#each engine.liveFeed as event}
										<div class="tw-flex tw-flex-col tw-p-3 tw-border-b tw-border-[#334155] last:tw-border-0 hover:tw-bg-[#1E293B] tw-transition-colors">
			...
			{#if activeTab === 'platform'}
				...
				<div class="tw-grid tw-grid-cols-1 xl:tw-grid-cols-12 tw-gap-6 tw-w-full">
					<div class="tw-col-span-1 xl:tw-col-span-12 tw-flex tw-flex-col">
						...
						<div class="tw-bg-[#0B0F19] tw-border tw-border-[#334155] tw-rounded-xl tw-p-8 tw-relative tw-overflow-hidden tw-group tw-transition-all tw-duration-500" class:tw-shadow-[0_0_30px_rgba(239,68,68,0.15)]={engine.maintenanceMode}>
							...
							<div class="tw-flex tw-flex-col sm:tw-flex-row sm:tw-items-center tw-justify-between tw-relative tw-z-10 tw-gap-6">
								<div class="tw-flex tw-flex-col">
									...
									<p class="tw-text-sm tw-text-[#94A3B8] tw-max-w-md tw-leading-relaxed">Instantly eject all non-admin users and block new sessions. API edges will return <code class="tw-font-mono tw-text-xs tw-text-[#FAFAFA] tw-bg-[#1E293B] tw-px-1.5 tw-py-0.5 tw-rounded tw-border tw-border-[#334155]">503 Service Unavailable</code>.</p>
								</div>
								
								<button 
									type="button"
									class="tw-group tw-relative tw-flex tw-items-center tw-gap-4 tw-pl-4 tw-pr-1.5 tw-py-1.5 tw-bg-[#020617] tw-border tw-rounded-full tw-transition-all tw-duration-300 focus:tw-outline-none"
								...
								>
									...
									<div class="tw-relative tw-w-14 tw-h-8 tw-rounded-full tw-transition-colors tw-duration-300 tw-ease-in-out tw-shadow-inner" class:tw-bg-[#ef4444]={engine.maintenanceMode} class:tw-bg-[#1E293B]={!engine.maintenanceMode}>
										<span class="tw-absolute tw-top-1 tw-left-1 tw-bg-[#FAFAFA] tw-w-6 tw-h-6 tw-rounded-full tw-shadow-sm tw-transition-transform tw-duration-300 tw-ease-[cubic-bezier(0.34,1.56,0.64,1)] tw-flex tw-items-center tw-justify-center" class:tw-translate-x-6={engine.maintenanceMode}>
