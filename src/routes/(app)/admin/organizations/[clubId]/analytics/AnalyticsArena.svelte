	...
	<div class="tw-col-span-1 md:tw-col-span-12 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-6">
		<div class="vanguard-panel tw-p-6 tw-flex tw-items-center tw-justify-between">
			...
			<div class="tw-h-16 tw-w-16 tw-rounded-none tw-border-4 tw-flex tw-items-center tw-justify-center"
				class:tw-border-[#14b8a6]={engine.complianceHealth.safeSport >= 95}
				class:tw-border-[#f59e0b]={engine.complianceHealth.safeSport < 95}>
		...
		<div class="vanguard-panel tw-p-6 tw-flex tw-items-center tw-justify-between">
			...
			<div class="tw-h-16 tw-w-16 tw-rounded-none tw-border-4 tw-flex tw-items-center tw-justify-center"
				class:tw-border-[#14b8a6]={engine.complianceHealth.vpc >= 95}
				class:tw-border-[#f59e0b]={engine.complianceHealth.vpc < 95}>
				<span class="tw-text-slate-400 tw-text-xs tw-font-mono">HLTH</span>
			</div>
		</div>
	</div>
