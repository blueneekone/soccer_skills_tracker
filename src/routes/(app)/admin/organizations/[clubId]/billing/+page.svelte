...
<div class="tw-flex tw-flex-col tw-gap-6 tw-w-full">
	...
	<div class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-12 tw-gap-6">
		...
		<div class="tw-col-span-1 lg:tw-col-span-8 tw-bg-[#0f172a] tw-border tw-border-[#334155] tw-rounded-xl tw-p-6">
			<h2 class="tw-text-[#FAFAFA] tw-font-bold tw-text-lg tw-mb-4 tw-m-0">Financial Interventions</h2>
			<div class="tw-flex tw-gap-4 tw-flex-wrap">
				<button class="tw-bg-[#334155] hover:tw-bg-[#475569] tw-text-[#FAFAFA] tw-px-4 tw-py-2 tw-rounded-lg tw-font-bold tw-text-sm tw-transition-colors" onclick={() => isCreditModalOpen = true}>
					Apply Credit
				</button>
				<button class="tw-bg-[#334155] hover:tw-bg-[#475569] tw-text-[#FAFAFA] tw-px-4 tw-py-2 tw-rounded-lg tw-font-bold tw-text-sm tw-transition-colors" onclick={() => isTrialModalOpen = true}>
					Extend Trial
				</button>
				<button class="tw-bg-[#7f1d1d] hover:tw-bg-[#991b1b] tw-text-[#FAFAFA] tw-px-4 tw-py-2 tw-rounded-lg tw-font-bold tw-text-sm tw-transition-colors tw-ml-auto" onclick={() => isRevokeModalOpen = true}>
		...
		<div class="tw-col-span-1 lg:tw-col-span-4 tw-bg-[#0f172a] tw-border tw-border-[#334155] tw-rounded-xl tw-p-6 tw-flex tw-flex-col tw-gap-4">
			...
			<div class="tw-mt-auto tw-bg-[#020617] tw-border tw-border-[#334155] tw-rounded-lg tw-p-3">
	...
	<div class="tw-bg-[#0f172a] tw-border tw-border-[#334155] tw-rounded-xl tw-overflow-hidden">
...
{#if isCreditModalOpen}
	<div class="tw-fixed tw-inset-0 tw-z-50 tw-flex tw-items-center tw-justify-center tw-bg-[#0B0F19]/80 tw-backdrop-blur-sm">
		<div class="tw-bg-[#0f172a] tw-border tw-border-[#334155] tw-rounded-xl tw-p-6 tw-max-w-md tw-w-full">
			...
			<div class="tw-flex tw-gap-3 tw-justify-end">
				...
				<button class="tw-bg-[#14b8a6] hover:tw-bg-[#0d9488] tw-text-[#020617] tw-font-bold tw-text-sm tw-px-4 tw-py-2 tw-rounded-lg" onclick={() => handleAction('credit')}>Confirm</button>
			</div>
		</div>
	</div>
{/if}
	...
	<div class="tw-fixed tw-inset-0 tw-z-50 tw-flex tw-items-center tw-justify-center tw-bg-[#0B0F19]/80 tw-backdrop-blur-sm">
		<div class="tw-bg-[#0f172a] tw-border tw-border-[#334155] tw-rounded-xl tw-p-6 tw-max-w-md tw-w-full">
			...
			<div class="tw-flex tw-gap-3 tw-justify-end">
				...
				<button class="tw-bg-[#14b8a6] hover:tw-bg-[#0d9488] tw-text-[#020617] tw-font-bold tw-text-sm tw-px-4 tw-py-2 tw-rounded-lg" onclick={() => handleAction('trial')}>Confirm</button>
			</div>
		</div>
	</div>
{/if}
...
{#if isRevokeModalOpen}
	<div class="tw-fixed tw-inset-0 tw-z-50 tw-flex tw-items-center tw-justify-center tw-bg-[#0B0F19]/80 tw-backdrop-blur-sm">
		<div class="tw-bg-[#0f172a] tw-border tw-border-[#ef4444] tw-rounded-xl tw-p-6 tw-max-w-md tw-w-full">
			...
			<div class="tw-flex tw-gap-3 tw-justify-end">
				...
				<button class="tw-bg-[#7f1d1d] hover:tw-bg-[#991b1b] tw-text-[#FAFAFA] tw-font-bold tw-text-sm tw-px-4 tw-py-2 tw-rounded-lg" onclick={() => handleAction('revoke')}>FORCE REVOKE</button>
			</div>
		</div>
	</div>
{/if}
