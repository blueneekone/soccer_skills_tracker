...
<div class="tw-flex tw-flex-col tw-gap-4 tw-p-6">
	...
	<div class="tw-w-full tw-overflow-x-auto tw-border tw-border-[#334155] tw-rounded-none tw-bg-[#020617]">
		<div class="tw-border tw-border-[#334155] tw-bg-[#0f172a] tw-p-4 tw-min-w-0 tw-overflow-x-auto"><table class="tw-w-full tw-font-mono tw-text-sm tw-min-w-[800px] tw-text-left tw-border-collapse">
