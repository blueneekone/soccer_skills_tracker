...
<div class="roster-page">
	...
	<div class="roster-dt-container">
		<div class="tw-border tw-border-[#334155] tw-bg-[#0f172a] tw-p-4 tw-min-w-0 tw-overflow-x-auto"><table class="tw-w-full tw-font-mono tw-text-sm roster-dt" aria-label="Team roster">
