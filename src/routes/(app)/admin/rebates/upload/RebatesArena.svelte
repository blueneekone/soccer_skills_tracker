		...
		{#if engine.validRows.length > 0}
			<div class="preview-table-wrap glass-panel st-bento lg:tw-col-span-8">
				...
				<div class="table-scroll">
					<div class="tw-border tw-border-[#334155] tw-bg-[#0f172a] tw-p-4 tw-min-w-0 tw-overflow-x-auto"><table class="tw-w-full tw-font-mono tw-text-sm" class="preview-table">
						<thead>
							<tr>
