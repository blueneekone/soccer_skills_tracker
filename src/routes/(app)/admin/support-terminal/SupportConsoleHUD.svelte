...
<div class="tw-flex tw-items-center tw-justify-between tw-flex-wrap tw-gap-3 tw-border-b tw-border-[#334155] tw-pb-4">
	...
	<div class="tw-flex-1 tw-flex tw-justify-end">
		...
		{:else}
			<span class="tw-inline-flex tw-items-center tw-gap-2 tw-text-xs tw-font-mono tw-text-[#14b8a6] tw-uppercase tw-tracking-wider">
				<span class="tw-w-2 tw-h-2 tw-bg-[#14b8a6] tw-rounded-none"></span>
				IDLE
			</span>
		{/if}
	</div>
