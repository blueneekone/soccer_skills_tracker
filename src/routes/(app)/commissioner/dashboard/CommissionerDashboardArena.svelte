	...
	{#if engine.isLoading}
		<div class="tw-flex-1 tw-flex tw-items-center tw-justify-center tw-py-20">
			<div class="tw-flex tw-items-center tw-gap-3">
				...
				<p class="tw-font-mono tw-text-sm tw-text-nuclear-yellow tw-tracking-widest tw-animate-pulse">LOADING_FEDERATION_TELEMETRY...</p>
			</div>
		</div>
	...
	{:else}
		...
		<div class="bento-grid-container tw-mb-6 tw-grid tw-gap-4" style="grid-template-columns: repeat(auto-fit, minmax(min(100%, clamp(280px, 30vw, 350px)), 1fr));">
			<div class="z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-flex tw-flex-col tw-min-w-0 hover:tw-border-nuclear-yellow hover:tw-shadow-neon-nuclear tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
				...
				<span class="tw-text-4xl tw-font-black tw-text-nuclear-yellow" style="font-family: 'Geist Mono', monospace;">{engine.totalClubs}</span>
			</div>
			...
			<div class="z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-flex tw-flex-col tw-min-w-0 hover:tw-border-nuclear-yellow hover:tw-shadow-neon-nuclear tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
				...
				<span class="tw-text-4xl tw-font-black tw-text-nuclear-yellow" style="font-family: 'Geist Mono', monospace;">100%</span>
			</div>
			...
			<div class="z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-flex tw-flex-col tw-min-w-0 hover:tw-border-nuclear-yellow hover:tw-shadow-neon-nuclear tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
				<div class="tw-flex tw-items-center tw-justify-between tw-mb-2">
					...
					<Icon name={"sys.server" as IconName} size={16} class="tw-text-nuclear-yellow" />
				</div>
				<span class="tw-text-4xl tw-font-black tw-text-nuclear-yellow" style="font-family: 'Geist Mono', monospace;">ACTIVE</span>
			</div>
		</div>
		...
		<div class="bento-grid-container tw-grid tw-grid-cols-1 lg:tw-grid-cols-12 tw-gap-6">
			...
			<div class="lg:tw-col-span-4 tw-flex tw-flex-col tw-gap-6 tw-min-w-0">
				<div class="st-bento z2-panel siem-panel tw-bg-[#0f172a] tw-border tw-border-[#334155] tw-rounded-none tw-flex tw-flex-col tw-min-w-0 hover:tw-border-nuclear-yellow tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
					<div class="tw-p-4 tw-border-b tw-border-[#334155] tw-flex tw-items-center tw-justify-between tw-min-w-0">
						<div>
							<h3 class="tw-text-[#FAFAFA] tw-font-bold tw-text-sm tw-uppercase tw-tracking-wider tw-flex tw-items-center tw-gap-2 tw-min-w-0" style="font-family: 'Geist Sans', sans-serif;">
								<Icon name={"data.radar" as IconName} size={16} class="tw-text-nuclear-yellow" />
								ODP Talent Vanguard
							</h3>
						...
						<span class="tw-text-[10px] tw-font-mono tw-text-nuclear-yellow tw-border tw-border-slate-700 tw-bg-slate-900 tw-px-2 tw-py-0.5">SIX_AXIS_RADAR</span>
					</div>
				...
				<div class="st-bento z2-panel siem-panel tw-p-4 tw-flex tw-flex-col tw-min-w-0 hover:tw-border-nuclear-yellow tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
					<h3 class="tw-text-xs tw-font-bold tw-uppercase tw-tracking-widest tw-text-[#FAFAFA] tw-mb-3 tw-flex tw-items-center tw-gap-2" style="font-family: 'Geist Sans', sans-serif;">
						<Icon name={"sys.network" as IconName} size={16} class="tw-text-nuclear-yellow" />
						ODP Pipeline Operations
					</h3>
					<div class="tw-flex tw-flex-col tw-gap-2">
						<a
							href="/commissioner/matrix"
							class="tw-px-3 tw-py-2 tw-text-xs tw-font-mono tw-font-bold tw-tracking-wider tw-uppercase tw-bg-[#1E293B] tw-border tw-border-[#334155] tw-text-slate-200 hover:tw-border-nuclear-yellow hover:tw-text-nuclear-yellow tw-transition-colors tw-flex tw-items-center tw-justify-between tw-no-underline"
						>
							<span class="tw-flex tw-items-center tw-gap-2">
								<Icon name={"content.grid" as IconName} size={14} class="tw-text-nuclear-yellow" />
								Compliance Matrix
							</span>
						...
						<button
							type="button"
							class="tw-px-3 tw-py-2 tw-text-xs tw-font-mono tw-font-bold tw-tracking-wider tw-uppercase tw-bg-transparent tw-border tw-border-nuclear-yellow tw-text-nuclear-yellow hover:tw-bg-nuclear-yellow hover:tw-text-void-black tw-transition-colors tw-flex tw-items-center tw-justify-between cursor-pointer"
		...
		<div class="commissioner-hud-grid bento-grid-container tw-mt-6 tw-grid tw-grid-cols-1 lg:tw-grid-cols-12 tw-gap-4">
			<div class="global-telemetry-feed lg:tw-col-span-8 z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-min-w-0 hover:tw-border-nuclear-yellow tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
			...
			<div class="system-health-diagnostics lg:tw-col-span-4 z2-panel siem-panel st-bento tw-p-[clamp(16px,3vw,24px)] tw-min-w-0 hover:tw-border-nuclear-yellow tw-transition-all" style="background: #0f172a; border: 1px solid #334155;">
				...
				<div class="tw-text-nuclear-yellow tw-text-xs tw-font-mono" style="font-family: 'Geist Mono', monospace;">Cryptographic RBAC Clearance (100%)</div>
			</div>
		</div>
	{/if}
</div>
